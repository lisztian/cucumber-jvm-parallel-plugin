...
@CucumberOptions(strict = true, features = {"classpath:features/feature1.feature"}, tags = {"@feature1"}, plugin = {"html:target/cucumber-parallel/1.html", "json:target/cucumber-parallel/1.json",
...
@RunWith(Cucumber.class)
@CucumberOptions(strict = true, features = {"classpath:features/feature2.feature"}, tags = {"@feature2"}, plugin = {"html:target/cucumber-parallel/2.html", "json:target/cucumber-parallel/2.json",
"pretty"}, monochrome = false, glue = { "foo" })
