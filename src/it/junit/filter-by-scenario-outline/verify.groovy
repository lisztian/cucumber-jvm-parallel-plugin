...
assert suite01.text.contains("feature1.feature:22")
assert suite02.text.contains("feature1.feature:23")
assert suite03.text.contains("feature1.feature:24")
assert suite04.text.contains("feature1.feature:25")
