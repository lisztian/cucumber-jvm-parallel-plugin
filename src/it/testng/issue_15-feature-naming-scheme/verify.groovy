...
@CucumberOptions(strict = true, features = {"classpath:features/feature1.feature"}, tags = {"@complete"},  plugin = {"json:target/cucumber-parallel/1.json",
...
@CucumberOptions(strict = true, features = {"classpath:features/feature2.feature"}, tags = {"@accepted"}, plugin = {"json:target/cucumber-parallel/2.json",
"pretty"}, monochrome = false,  glue = { "foo", "bar" })
