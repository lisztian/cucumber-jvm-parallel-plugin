...
@CucumberOptions(strict = true, features = {"src/test/resources/features/feature1.feature"}, tags = {"@complete"}, plugin = {"json:target/my-custom-dir/1.json",
...
@CucumberOptions(strict = true, features = {"src/test/resources/features/feature2.feature"}, tags = {"@accepted"}, plugin = {"json:target/my-custom-dir/2.json",
"pretty"}, monochrome = false,  glue = { "foo", "bar" })
